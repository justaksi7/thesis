...
Zur Überprüfung der beiden Hypothesen wurden Bootstrap-Verfahren eingesetzt, die keine Normalverteilungsannahme voraussetzen und robust gegenüber Ausreißern sind. Alle Tests wurden auf einem Signifikanzniveau von \(\alpha = 0{,}05\) durchgeführt. Aufgrund der Vielzahl der Vergleiche wurde eine Bonferroni-Korrektur angewendet (siehe Anhang).
