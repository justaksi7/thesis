...
Für diese Arbeit ist das Zusammenspiel beider Konzepte zentral, weil \ac{FaaS} typischerweise als Event-Consumer und / oder -Producer in einer ereignisgesteuerten Microservices-Umgebung agieren~\cite{AWSLambdaDocs}.
...
da die Serverless-Technologien und die FaaS-Platformen speziell für die Entwicklung von Microservices konzipiert sind (siehe Abschnitt~\ref{sec:serverless}). 
