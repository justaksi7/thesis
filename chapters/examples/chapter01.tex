...
\paragraph{Kapitel \ref{ch:chapter05}} präsentiert die Ergebnisse der Messungen, gegliedert nach Laufzeit-, maximalem Speicherverbrauch- und Kaltstartzeit-Overhead sowie nach Sprachen und Anwendungsfällen.

\paragraph{Kapitel \ref{ch:chapter06}} diskutiert die Ergebnisse im Hinblick auf die Forschungsfragen, vergleicht sie gegebenenfalls mit verwandten Arbeiten und reflektiert Limitationen der Arbeit.

\paragraph{Kapitel \ref{ch:chapter07}} leitet aus den Ergebnissen praxisrelevante Empfehlungen zur Sprachwahl ab.

\paragraph{Kapitel \ref{ch:chapter08}} fasst die Arbeit zusammen, hebt den wissenschaftlichen Beitrag hervor und gibt einen Ausblick auf mögliche Fragestellungen für spätere Arbeiten.
