...
\usepackage{booktabs} % Für professionelle horizontale Linien
\usepackage{multirow} % Für die vertikale Zentrierung von "Runtime"
\usepackage{xcolor}    % Falls du die grauen Hinterlegungen nutzen möchtest
\usepackage{colortbl}
...
\include{chapters/examples/chapter08}
